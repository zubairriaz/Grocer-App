...
import { CanActivate, ActivatedRouteSnapshot, RouterStateSnapshot, UrlTree, CanActivateChild, CanLoad, Router, Route } from '@angular/router';
...
export class AuthGuard implements CanActivate, CanActivateChild, CanLoad {
  constructor(private authService:AuthService, protected router:Router , protected uiService: UIService){}
  canActivate(
